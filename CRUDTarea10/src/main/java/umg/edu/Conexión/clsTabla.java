...
public class clsTabla {
    ...
    public void insertarDatos() {
        ...
        String consulta = "INSERT INTO crudtarea10 (nombreyapellido, fecha, sueldobase, sexo, longitudylatitud, Comentarios) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void mostrarTabla() {
        clsConexión conexion = new clsConexión();
        String sql = "SELECT * FROM crudtarea10";
    ...
    public void borrarDatos() {
        ...
        String sql = "DELETE FROM crudtarea10 WHERE id = ?";
    ...
    public void modificarDatos() {
        ...
        String sql = "UPDATE crudtarea10 SET nombreyapellido = ?, fecha = ?, sueldobase = ?, sexo = ?, longitudylatitud = ?, Comentarios = ? WHERE id = ?";
